...
<body onload="startTime()">
    ...
    <div id="main-wrapper" data-layout="vertical" data-navbarbg="skin5" data-sidebartype="full"
        ...
        <!-- ============================================================== -->
        <?php
          include_once 'layouts/userLayouts/headerLayout.php';
        ?>
        <!-- ============================================================== -->
        <!-- End Topbar header -->
        <!-- ============================================================== -->
        ...
        <!-- ============================================================== -->
        <?php
            include_once 'layouts/userLayouts/sidebarLayout.php';
        ?>
        <!-- ============================================================== -->
        ...
        <div class="page-wrapper">
            <?php
                if(isset($_GET['users'])){
                    include_once 'layouts/userLayouts/usersLayout.php';
                }
                elseif(isset($_GET['bankaccounts'])){
                    include_once 'layouts/userLayouts/bankaccountLayout.php';
                }
                elseif(isset($_GET['maintenance'])){
                    include_once 'layouts/userLayouts/maintenanceLayout.php';
                }
                elseif(isset($_GET['reports'])){
                    include_once 'layouts/userLayouts/reportLayout.php';
                }
                elseif(isset($_GET['profile'])){
                    include_once 'layouts/userLayouts/profileLayout.php';
                }
                else{
                    include_once 'layouts/userLayouts/dashboardLayout.php';
                }
            ?>
            <!-- ============================================================== -->
            <!-- End Container fluid  -->
            ...
            <!-- ============================================================== -->
            <?php
                include_once 'layouts/userLayouts/footerLayout.php';
            ?>
            <!-- ============================================================== -->
            <!-- End footer -->
            <!-- ============================================================== -->
