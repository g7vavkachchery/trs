...
<?php
    ...
    if(!$_SESSION['un'] && $_SESSION['ut'] != "Admin"){
...
<body onload="startTime()">
    ...
    <div id="main-wrapper" data-layout="vertical" data-navbarbg="skin5" data-sidebartype="full"
        ...
        <!-- ============================================================== -->
        <?php
          include_once 'layouts/adminLayouts/headerLayout.php';
        ?>
        <!-- ============================================================== -->
        <!-- End Topbar header -->
        <!-- ============================================================== -->
        ...
        <!-- ============================================================== -->
        <?php
            include_once 'layouts/adminLayouts/sidebarLayout.php';
        ?>
        <!-- ============================================================== -->
        ...
        <div class="page-wrapper">
            <?php
                if(isset($_GET['users'])){
                    include_once 'layouts/adminLayouts/usersLayout.php';
                }
                elseif(isset($_GET['bankaccounts'])){
                    include_once 'layouts/adminLayouts/bankaccountLayout.php';
                }
                elseif(isset($_GET['maintenance'])){
                    include_once 'layouts/adminLayouts/maintenanceLayout.php';
                }
                elseif(isset($_GET['reports'])){
                    include_once 'layouts/adminLayouts/reportLayout.php';
                }
                elseif(isset($_GET['profile'])){
                    include_once 'layouts/adminLayouts/profileLayout.php';
                }
                else{
                    include_once 'layouts/adminLayouts/dashboardLayout.php';
                }
            ?>
            <!-- ============================================================== -->
            <!-- End Container fluid  -->
            ...
            <!-- ============================================================== -->
            <?php
                include_once 'layouts/adminLayouts/footerLayout.php';
            ?>
            <!-- ============================================================== -->
            <!-- End footer -->
            <!-- ============================================================== -->
    ...
    <script>
        function validateForm1(){
            ...
            .then((willDelete) => {
                if (willDelete) {
                    ...
                    swal('User Account Blocking was Cancelled Successfully!', {
                        icon: 'info',
                    });
                }
            });
        ...
        function validateForm2(){
            ...
            .then((willDelete) => {
                if (willDelete) {
                    ...
                    swal('User Account activating was Cancelled Successfully!', {
                        icon: 'info',
                    });
                }
            });
        ...
        function validateForm3(){
            ...
            swal({
                title: 'Are you sure?',
                text: 'You want to Remove this User Request!',
                icon: 'warning',
                buttons: true,
                dangerMode: true,
            })
            .then((willDelete) => {
                if (willDelete) {
                    ...
                    swal('User Request Remove Process was Cancelled Successfully!', {
                        icon: 'info',
                    });
                }
            });
        ...
        function validateForm4(){
            ...
            swal({
                title: 'Are you sure?',
                text: 'You want to Reset this user account\'s password!',
                icon: 'warning',
                buttons: true,
                dangerMode: true,
            })
            .then((willDelete) => {
                if (willDelete) {
                    ...
                    swal('User Password Resetting was Cancelled Successfully!', {
                        icon: 'info',
                    });
                }
            });
        ...
        function validateForm8(){
            ...
            swal({
                title: 'Are you sure?',
                text: 'You want to Remove this User Row!',
                icon: 'warning',
                buttons: true,
                dangerMode: true,
            })
        ...
        function downloadTPR(){
            ...
            html2pdf().from(invoice).set(opt).toPdf().get('pdf').then(function (pdf) {
                ...
                for (var i = 1; i <= totalPages; i++) {
                    ...
                    pdf.text('Page ' + i + ' of ' + totalPages, pdf.internal.pageSize.getWidth()/2, 
                    (pdf.internal.pageSize.getHeight()/ 100)*97.5);
                    pdf.text('BADMS - Transaction Reports Downloaded at <?=date("h:m:s a d-m-Y");?>', (pdf.internal.pageSize.getWidth()/100)*1, 
                    (pdf.internal.pageSize.getHeight()/ 100)*2.5);
                }
            }).save();
        }
