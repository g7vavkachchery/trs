...
<div class="container-fluid">
    <div class="row">
        <div class="col-md-6">
            <div class="card">
                <form class="form-horizontal" method="POST" name="updatebasicdetailform" id="updatebasicdetailform" action="admin.php?profile">
                    <div class="card-body">
        ...
        <div class="col-md-6">
            <div class="card">
                <form class="form-horizontal" method="POST" name="updatesecuritydetails" id="updatesecuritydetails" action="admin.php?profile">
                    <div class="card-body">
    ...
    <div class="row">
        <div class="col-md-6">
            <div class="card">
                <form class="form-horizontal" method="POST" name="updatepassword" id="updatepassword" action="admin.php?profile">
                    <div class="card-body">
