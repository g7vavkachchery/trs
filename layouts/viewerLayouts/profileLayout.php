        ...
        <div class="col-12 d-flex no-block align-items-center">
            ...
            <div class="ms-auto text-end">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="viewer.php">Home</a></li>
...
<div class="container-fluid">
    <div class="row">
        <div class="col-md-6">
            <div class="card">
                <form class="form-horizontal" method="POST" name="updatebasicdetailform" id="updatebasicdetailform" action="viewer.php?profile">
                    <div class="card-body">
        ...
        <div class="col-md-6">
            <div class="card">
                <form class="form-horizontal" method="POST" name="updatesecuritydetails" id="updatesecuritydetails" action="viewer.php?profile">
                    <div class="card-body">
    ...
    <div class="row">
        <div class="col-md-6">
            <div class="card">
                <form class="form-horizontal" method="POST" name="updatepassword" id="updatepassword" action="viewer.php?profile">
                    <div class="card-body">
